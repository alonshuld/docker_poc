...
class ContainersErrors(Enum):
    ...
    CPU_LIMIT_VALUE_OUT_OF_SCOPE = "CPU limit should be a percentage number between 0 and 100 (from the total CPU)"
...
class RunningContainerException(Exception):
    """Custom Exception for wrong use with Running Containers"""
